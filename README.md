...
La sección **Reglas** de la app explica con un esquema y el catálogo vivo de misiones cómo se consiguen los bonus y cómo funcionan el saldo y los premios. Las propuestas visuales para elegir la futura interfaz están en [`docs/ui-proposals/index.html`](docs/ui-proposals/index.html): Arcade, Mapa de misiones y Agenda visual. Son HTML de demostración y no modifican los datos familiares.
...
La base D1 del Site publicado y la D1 local de Wrangler son independientes. Esta rama no modifica ni sincroniza el Site. La nueva SQLite arranca vacía por elección. Tras crear el acceso familiar en Linux se puede importar manualmente un JSON exportado por la propia app; las credenciales del Site no viajan en ese archivo.
