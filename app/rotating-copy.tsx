...
const copy={
  es:[
    ...
    ['Cambia “qué pereza”','por “dos minutos”.','A veces el truco más potente es engañar al cerebro con una tarea pequeña.'],
    ['Tu casa es base.','Cuídala.','No es un hotel. Aunque el servicio de habitaciones sigue siendo sospechosamente bueno.'],
    ['La lista existe','para liberarte.','Mirarla no hace las tareas. Pero evita que vivan rent free en tu cabeza.'],
    ...
    ['Hazlo sencillo.','Hazlo tuyo.','Cuando una tarea tiene tu forma, dura más que una norma gritada.'],
